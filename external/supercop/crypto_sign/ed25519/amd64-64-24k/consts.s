#ifdef __APPLE__
  #define qsf_LOCAL_SYMBOL(x) .private_extern x
#else
  #define qsf_LOCAL_SYMBOL(x) .hidden x
#endif
...
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_121666)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU0)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU1)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU2)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU3)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_MU4)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER0)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER1)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER2)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_ORDER3)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D0)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D1)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D2)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_EC2D3)
qsf_LOCAL_SYMBOL(crypto_sign_ed25519_amd64_64_38)
