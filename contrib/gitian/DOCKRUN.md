...
*Setup instructions for a Gitian build of qsf using Docker.*
...
You'll also need to clone the qsf repository and navigate to the `contrib/gitian` directory:

```bash
git clone https://github.com/qsf-project/qsf.git
cd qsf/contrib/gitian
```
...
* a fork of the [gitian.sigs](https://github.com/qsf-project/gitian.sigs/) repo on your GitHub account.
