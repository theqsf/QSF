...
RUN	git clone https://github.com/qsf-project/gitian.sigs.git sigs; \
  ...
  git clone https://github.com/qsf-project/qsf
...
if [ ! -d sigs ]; then
	git clone https://github.com/qsf-project/gitian.sigs.git sigs
	cd sigs
