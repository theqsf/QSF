...
* Running qsf node, linked to private/public testnet. 
  ...
  [Manual](https://github.com/qsfexamples/private-testnet) explaining how to run private testnet.
...
* Directory with pre-generated wallets
  ...
  By default, tests expect these wallets to be in ```/var/qsf/testnet_pvt```. 
