...
- [ ] Notify wallets
  ...
  - [ ] QSFWallet
- [ ] Notify exchanges
  - [ ] https://web.getqsf.org/community/merchants/#exchanges
- [ ] Notify 3rd party payment processors
  - [ ] https://web.getqsf.org/community/merchants/#payment-gateways
- [ ] Notify mining pools
  - [ ] https://miningpoolstats.stream/qsf
- [ ] Release tagged
  - [ ] Update src/version.cpp.in with new version AND new name (if necessary)
  - [ ] Update Gitian YML files in contrib/gitian/ to the new version number
  - [ ] Update README.md with new fork table entry (or at least update the Recommended QSF version)
  ...
  - [ ] Update src/blocks/checkpoints.dat with ./qsf-blockchain-export --output-file checkpoints.dat --block-stop <recent block height> --blocksdat
...
- [ ] CLI released
  - [ ] https://web.getqsf.org/downloads/ updated
