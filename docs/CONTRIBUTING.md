...
posted to #qsf-dev on irc.libera.chat).
...
The "QSF Maintainer Team" is defined in this document as the following users:
- fluffypony
- qsfmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to QSF code or QSF's dependency code or QSF's potential/future dependency code or research which successfully implements QSF.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the QSF Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the QSF Maintainer Team.
