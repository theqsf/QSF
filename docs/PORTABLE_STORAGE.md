...
QSF makes use of a set of helper classes from a small library named
[epee](https://github.com/qsf-project/qsf/tree/master/contrib/epee). Part
of this library implements a networking protocol called
[Levin](https://github.com/qsf-project/qsf/blob/master/contrib/epee/include/net/levin_base.h),
which internally uses a storage format called [Portable
Storage](https://github.com/qsf-project/qsf/tree/master/contrib/epee/include/storages).
This format (amongst the rest of the
[epee](https://github.com/qsf-project/qsf/tree/master/contrib/epee)
...
```json
{
  ...
  "long_quote": "QSF is more than just a technology. It's also what the technology stands for.",
...
#### Links to some QSF struct definitions

- [Core RPC
  definitions](https://github.com/qsf-project/qsf/blob/master/src/rpc/core_rpc_server_commands_defs.h)
- [CryptoNote protocol
  definitions](https://github.com/qsf-project/qsf/blob/master/src/cryptonote_protocol/cryptonote_protocol_defs.h)
