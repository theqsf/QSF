# qsf Blockchain Stats

qsf Blockchain Stats utlity exports daily statistics for the qsf blockchain from creation through current state.

## Usage:

See also the utility's help option. `qsf-blockchain-stats --help`
...
- `qsf-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `qsf-blockchain-stats | save-to-database.sh`
